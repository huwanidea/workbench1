...
import "@/performance/sop-templates.css";
...
const workbenchMarkup = `
  ...
  <dialog id="milestone-dialog" class="modal project-dialog"><form id="milestone-form"><div class="modal-head"><div><span class="summary-dialog-kicker">项目里程碑</span><h2 id="milestone-dialog-title">新建里程碑</h2></div><button type="button" class="icon-button" data-action="cancel-milestone" aria-label="关闭">×</button></div><div id="milestone-form-fields" class="form-grid"></div><div class="modal-foot"><button type="button" class="button ghost" data-action="cancel-milestone">取消</button><button type="submit" class="button primary">保存里程碑</button></div></form></dialog>
  <dialog id="project-task-dialog" class="modal project-dialog"><form id="project-task-form"><div class="modal-head"><div><span class="summary-dialog-kicker">项目任务</span><h2 id="project-task-dialog-title">新建任务</h2></div><button type="button" class="icon-button" data-action="cancel-project-task" aria-label="关闭">×</button></div><div id="project-task-form-fields" class="form-grid"></div><div class="modal-foot"><button type="button" class="button ghost" data-action="cancel-project-task">取消</button><button type="submit" class="button primary">保存任务</button></div></form></dialog>
  ...
  <dialog id="sop-template-dialog" class="modal sop-template-dialog"><form id="sop-template-form"><div class="modal-head"><div><span class="summary-dialog-kicker">SOP 项目模板</span><h2 id="sop-template-dialog-title">新建 SOP 模板</h2></div><button type="button" class="icon-button" data-action="cancel-sop-template" aria-label="关闭">×</button></div><div id="sop-template-form-fields" class="sop-template-form-fields"></div><div class="modal-foot"><button type="button" class="button ghost" data-action="cancel-sop-template">取消</button><button type="submit" class="button primary">保存模板</button></div></form></dialog>
